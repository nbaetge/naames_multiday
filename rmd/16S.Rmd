...
**Our groups (Days) within N2S4 and N3S6 do present homogeneity among group dispersions (compositions vary similarly)** 
...
**Our groups (days) at N3S6 present homogeneity among group
...
pivot.data_n2s4 <- alphadiv_n2s4 %>% 
 ...
 alpha.plot_n2s4 <- pivot.data_n2s4 %>% 
  ...
  theme_classic2(base_size = 16) +
  labs(x = "Days", y =  "Alpha Diversity Measure", fill = "Depth, m") + 
  stat_compare_means()  +
...
The richness (via Chao index) of our samples  did not significantly change and the overall diversity (via Shannon index) also did not change at N2S4.
Did see a change in richness and overall diversity in the 100-200 m bin at N3S6
