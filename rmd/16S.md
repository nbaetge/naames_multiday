...
![](16S_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
```
    ...
    ## Groups     1 2074649 2074649  54.066 2.699e-09 ***
    ## Residuals 46 1765122   38372                      
    ## ---
...
```
    ...
    ## Response: Distances
    ##           Df  Sum Sq Mean Sq F value Pr(>F)
    ## Groups     2  4758.2  2379.1  0.8965 0.4564
    ## Residuals  6 15923.0  2653.8
...
```
    ...
    ## Response: Distances
    ##           Df Sum Sq Mean Sq F value Pr(>F)
    ## Groups     2  17014  8507.1  1.3576 0.3053
    ## Residuals  9  56398  6266.4
...
```
    ...
    ## Response: Distances
    ##           Df Sum Sq Mean Sq F value Pr(>F)
    ## Groups     2  39665   19832  2.5743 0.1912
    ## Residuals  4  30816    7704
...
```
    ...
    ## Response: Distances
    ##           Df Sum Sq Mean Sq F value Pr(>F)
    ## Groups     2   3758    1879  0.0413 0.9597
    ## Residuals 17 773882   45522

**Our groups (depth horizon, Days) within N2S4 and N3S6 do present
homogeneity among group dispersions (compositions vary similarly)**
...
```
    ...
    ## 
    ## Call:
    ## adonis(formula = euc_dist_n2s4_ez ~ sample_info_tab_n2s4_ez$days) 
    ## 
    ## Permutation: free
    ...
    ## sample_info_tab_n2s4_ez$days  1     15588   15588 0.52636 0.06994  0.952
    ## Residuals                     7    207304   29615         0.93006       
    ## Total                         8    222892                 1.00000
...
```
    ...
    ## 
    ## Call:
    ## adonis(formula = euc_dist_n2s4_mz ~ sample_info_tab_n2s4_mz$days) 
    ## 
    ## Permutation: free
    ## Number of permutations: 999
    ## 
    ...
    ## 
    ##                              Df SumsOfSqs MeanSqs F.Model      R2 Pr(>F)  
    ## sample_info_tab_n2s4_mz$days  1    170718  170718  5.1798 0.34123  0.011 *
    ## Residuals                    10    329581   32958         0.65877         
    ## Total                        11    500299                 1.00000         
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## 
    ## Call:
    ## adonis(formula = euc_dist_n3s6_ez ~ sample_info_tab_n3s6_ez$days) 
    ## 
    ## Permutation: free
    ...
    ## 
    ##                              Df SumsOfSqs MeanSqs F.Model      R2 Pr(>F)
    ## sample_info_tab_n3s6_ez$days  1     52653   52653 0.77729 0.13454  0.496
    ## Residuals                     5    338692   67738         0.86546       
    ## Total                         6    391345                 1.00000
...
```
    ...
    ## 
    ## Call:
    ## adonis(formula = euc_dist_n3s6_mz ~ sample_info_tab_n3s6_mz$days) 
    ## 
    ## Permutation: free
    ## Number of permutations: 999
    ## 
    ...
    ## 
    ##                              Df SumsOfSqs MeanSqs F.Model     R2 Pr(>F)
    ## sample_info_tab_n3s6_mz$days  1    222363  222363 0.96139 0.0507  0.372
    ## Residuals                    18   4163287  231294         0.9493       
    ## Total                        19   4385650                 1.0000
...
**Our groups (depth horizon, days) at N3S6 present homogeneity among
...
using pairwise t-tests; p \< 0.05 was considered the threshold
...
![](16S_files/figure-gfm/unnamed-chunk-67-1.png)<!-- -->

``` r
(relaheat_combine_s4 + relaheat_del_combine_s4) 
```

![](16S_files/figure-gfm/unnamed-chunk-68-1.png)<!-- -->

``` r
(relaheat_combine_s6 + relaheat_del_combine_s6) 
```

![](16S_files/figure-gfm/unnamed-chunk-69-1.png)<!-- -->
