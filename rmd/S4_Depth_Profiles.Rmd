...
mld.plot <-  data %>% 
  ...
  labs(x = expression(italic(paste("Days"))), y = expression(italic(paste("MLD, m"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location") +
...
chl.plot <-  data %>% 
  ...
  labs(x = expression(italic(paste("Depth, m"))), y = expression(italic(paste("Chl a, mg m"^"-3"))), colour = "", fill = "Days", linetype = "Eddy Location", shape = "Eddy Location") +
  expand_limits(x = 300) +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
...
phyto.plot <-  data %>% 
  ...
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste("Depth, m"))), y = expression(italic(paste("Phytoplankton Cells, m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  expand_limits(x = 300) +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
...
phyc.plot <-  data %>% 
 ...
 filter(z %in% c(0, 5, 10, 25, 50, 75, 100, 150, 200, 300)) %>% 
  ...
  geom_line(aes(linetype = eddy, colour = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste("Depth, m"))), y = expression(italic(paste("Phytoplankton Carbon, mmol m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  expand_limits(x = 300) +
  scale_x_reverse() +
  coord_flip() +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
npp.plot <-  npp %>% 
  ...
  labs(x = expression(italic(paste("Depth, m"))), y = expression(italic(paste("Modeled NPP, mmol m"^-3, "d"^-1))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  expand_limits(x = 300) +
  scale_x_reverse() +
  coord_flip() +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
n.plot <-  data %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6,  color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("N + N, mmol m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
doc.plot <-  data %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("DOC, mmol m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
tdaa.plot <-  data %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("TDAA, mmol C m"^-3))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
tdaaY.plot <-  data %>% 
  ...
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("TDAA Yield, %"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
aou.plot <-  ctd %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("AOU, mmol m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  # scale_color_date(low = "#0db5e6", high = "#d31f2a") +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
ba.plot <-  data %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("Bacterioplankton Cells, m"^"-3"))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
...
bcd.plot <-  data %>% 
  ...
  geom_line(aes(linetype = eddy, color = days), size = 0.7) +
  geom_point(aes(shape = eddy, fill = days), size = 6, color = "black", stroke = 1, alpha = 0.7) + 
  labs(x = expression(italic(paste(""))), y = expression(italic(paste("BCD, mmol C m"^"-3","d"^-1))), colour = "", linetype = "Eddy Location", shape = "Eddy Location", fill = "Days") +
  scale_x_reverse() +
  coord_flip() +
  scale_shape_manual(values = c("Core" = 21, "Outside" = 24)) +
  # scale_fill_date(low = "#0db5e6", high = "#d31f2a") +
