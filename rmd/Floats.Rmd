...
t.plot <- t_odv_data %>% 
  ...
  scale_fill_gradientn(colors = new_colors, na.value = NA, values = rescale(c(13, 15, 16)), limits = c(13,16)) +
  scale_y_reverse() +
...
s.plot <- s_odv_data %>% 
  ...
  geom_line(data = profile_points, aes(x = datetime, y = MLD), color = "White", linetype = 1, size = 1.5 ) +
  geom_line(data = profile_points[!is.na(profile_points$ezd),], aes(x = datetime, y = ezd), color = "Red", size = 1.5 ) +
  scale_fill_gradientn(colors = new_colors, na.value = NA) +
  scale_y_reverse() +
...
t.plot <- t_odv_data %>% 
  ...
  geom_line(data = profile_points, aes(x = datetime, y = MLD), color = "White", linetype = 1, size = 1.5 ) +
  geom_line(data = profile_points[!is.na(profile_points$ezd),], aes(x = datetime, y = ezd), color = "Red", size = 1.5 ) +
  scale_fill_gradientn(colors = new_colors, na.value = NA, values = rescale(c(1, 8, 18)), limits = c(1,18)) +
  scale_y_reverse() +
