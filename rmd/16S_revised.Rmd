...
nmds.plot <- plot_ordination(ps_min, nmds,  title = "NAAMES 2 Station 4 & NAAMES 3") +
  geom_point(aes(fill = Cruise, shape = dh), alpha = 0.7, size = 4) +
  stat_ellipse(aes(group = Cruise), color = "firebrick", level = 0.95, type = "t", size = 0.7) +
...
```{r fig.height=12, fig.width=29, message=TRUE, warning=FALSE}
