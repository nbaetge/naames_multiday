...
```{r combine plots, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 18, fig.width = 22}

patchwork <- mld.plot  + t.plot +  chl.plot + phyc.plot + phyto.plot +   npp.plot + n.plot + aou.plot + doc.plot  +  ba.plot + bp.plot + bcd.plot
