...
Here, we plot the profiles from the multiday NAAMES station, N3S6 .These casts have different T-S plots than all the float profiles and 7 of the ship profiles: plot_date %in% c("Sep 14 15:33", "Sep 15 03:04", "Sep 15 15:20", "Sep 16 03:04", "Sep 16 04:50", "Sep 16 07:26"). We'll exclude these from these analyses. 
...
doc.plot <- bf %>% 
  ...
  geom_errorbar(aes(x = z, ymin = doc - sd_doc, ymax = doc + sd_doc, color = plot_date), width = 5) +
  geom_line(aes(color = plot_date), size = 0.7) +
  geom_point(aes(fill = plot_date), shape = 21, size = 6, color = "black", stroke = 1, alpha = 0.7) + 
...
ba.plot <-  bf %>% 
  ...
  geom_errorbar(aes(x = z, ymin = ba - sd_ba, ymax = ba + sd_ba, color = plot_date), width = 5) +
  geom_line(aes(color = plot_date), size = 0.7) +
  geom_point(aes(fill = plot_date), shape = 21, size = 6, color = "black", stroke = 1, alpha = 0.7) + 
