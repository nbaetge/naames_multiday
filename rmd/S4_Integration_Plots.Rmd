...
phyc.plot <-  pivoted %>% 
  ...
  geom_point(aes(shape = eddy, fill = factor(depth_interval, levels = levels)), size = 6, color = "black", stroke = 1, alpha = 0.7) +  
...
patchwork <- phyto.plot + ba.plot + phyc.plot + bc.plot +    npp.plot + bcd.plot + doc.plot + tdaa.plot + aou.plot + ou.plot
